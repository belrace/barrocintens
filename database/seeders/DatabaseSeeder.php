...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $products = [
            ['id' => 1, 'name' => 'Bit-Deluxe', 'description' => 'The better version of the Bit collection!', 'image_path' => 'machinebitdeluxe2.png', 'brand' => 'Bit', 'price' => 499, 'stock' => 100, 'product_category_id' => 1],
            ...
            ['id' => 3, 'name' => 'Espresso Beneficio', 'description' => 'Een toegankelijke en zachte koffie. Hij is afkomstig van de Finca El Limoncillo, een weelderige plantage aan de rand van het regenwoud in de Matagalpa regio in Nicaragua.', 'image_path' => 'bonenzak1.png', 'brand' => 'Espresso Beneficio', 'price' => 21.60, 'stock' => 100, 'product_category_id' => '2'],
            ...
            ['id' => 5, 'name' => 'Espresso Roma', 'description' => 'Een Italiaanse espresso met een krachtig karakter en een aromatische afdronk.', 'image_path' => 'bonenzak3.png', 'brand' => 'Espresso Roma', 'price' => 20.80, 'stock' => 100, 'product_category_id' => '2'],
